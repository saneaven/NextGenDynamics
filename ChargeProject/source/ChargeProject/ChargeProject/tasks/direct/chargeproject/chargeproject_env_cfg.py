...
class ChargeprojectEnvCfg(DirectRLEnvCfg):
    ...
    progress_reward_scale = 0 # 50.0 # 50/7.5
    # progress_target_divisor = 7.5
    velocity_alignment_reward_scale = 1.2 # 10.0
    # Multiplied by targets hit reward
    reach_target_reward_scale = 100.0 # 500./15.
    forward_vel_reward_scale = 100.0 # 1.2 # 0
    flat_orientation_reward_scale = -15
    feet_air_time_reward_scale = 0.005
    life_time_reward_scale = 1.0
    time_penalty_scale = 0 #-5
    death_penalty_scale = -100
    still_penalty_scale = -10
    # lin_vel_reward_scale = 1.5
    # yaw_rate_reward_scale = 0.75
    z_vel_penalty_scale = -2
    ang_vel_penalty_scale = -0.0375
    joint_torque_penalty_scale = -5e-9
    joint_accel_penalty_scale = -1.5e-7
    dof_vel_penalty_scale = 0
    action_rate_penalty_scale = -0.003
    undesired_contact_penalty_scale = -0.75*3
