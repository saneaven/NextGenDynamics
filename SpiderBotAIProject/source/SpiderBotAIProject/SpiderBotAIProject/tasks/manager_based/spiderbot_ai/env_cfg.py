...
class RewardsCfg:
    ...
    progress = RewTerm(func=mdp.progress_reward, weight=7.5e3)
    velocity_alignment = RewTerm(func=mdp.velocity_alignment_reward, weight=3.0e2)
    ...
    wall_proximity = RewTerm(func=mdp.wall_proximity_penalty, weight=-5.0e1)
